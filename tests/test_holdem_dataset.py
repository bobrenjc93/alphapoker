...
def test_generate_equity_policy_examples_from_tight_range_safe_rollout_expert() -> None:
    examples = generate_equity_policy_examples(
        hands=1,
        seed=31,
        equity_sims=1,
        rollout_sims=1,
        expert_policy="tight-range-safe-rollout-pot-odds",
...
def test_generate_equity_policy_examples_from_tight_range_default_safe_rollout_expert() -> None:
    examples = generate_equity_policy_examples(
        hands=1,
        seed=32,
        equity_sims=2,
        rollout_sims=1,
        expert_policy="tight-range-default-safe-rollout-pot-odds",
        opponent_policy="tight-range-pot-odds",
        soft_target_temperature=1.0,
    )
